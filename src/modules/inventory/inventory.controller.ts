...
export class InventoryController {
  ...
  findAll(@GetSellerContext() sellerContext: SellerContext): Promise<InventoryResponseDto[]> {
    return this.inventoryService.findAll(sellerContext);
  }
  ...
  @ApiBearerAuth('JWT-auth')
  getLowStockItems(@GetSellerContext() sellerContext: SellerContext): Promise<InventoryResponseDto[]> {
    return this.inventoryService.getLowStockItems(sellerContext);
  }
