...
export class UsersController {
  ...
  @UseGuards(AuthGuard('jwt'), RolesGuard)
  @Roles(Role.ADMIN)
  @ApiOperation({ summary: 'Update user status (admin only) - Block/Unblock user' })
  @ApiResponse({
    status: HttpStatus.OK,
  ...
  updateUserStatus(
    ...
    if (id === req.user.id && updateStatusDto.status === 'BLOCKED') {
  ...
  @UseGuards(AuthGuard('jwt'), RolesGuard)
  @Roles(Role.ADMIN)
  @ApiOperation({ summary: 'Update user role (admin only) - Promote USER to SELLER' })
  @ApiResponse({
    status: HttpStatus.OK,
  ...
  @ApiNotFoundResponse({ description: 'User not found' })
  @ApiBadRequestResponse({ description: 'Invalid role or user already has this role' })
  @ApiUnauthorizedResponse({ description: 'Unauthorized' })
  @ApiForbiddenResponse({ description: 'Forbidden - Not an admin' })
  @ApiBearerAuth('JWT-auth')
  @ApiParam({ name: 'id', description: 'User ID' })
  ...
  @ApiOperation({ summary: 'Delete user (admin only) - Cannot delete admin users' })
  @ApiResponse({
    status: HttpStatus.NO_CONTENT,
    description: 'User deleted successfully',
  })
  @ApiNotFoundResponse({ description: 'User not found' })
  @ApiBadRequestResponse({ description: 'Cannot delete admin users' })
  @ApiUnauthorizedResponse({ description: 'Unauthorized' })
  @ApiForbiddenResponse({ description: 'Forbidden - Not an admin' })
  @ApiBearerAuth('JWT-auth')
  @ApiParam({ name: 'id', description: 'User ID' })
